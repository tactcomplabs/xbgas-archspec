...
Store a 128-bit word using the value in the register pair \regpair{ext1}{rs1} 
as the source to the 128-bit address formed by adding the immediate value to 
the 128-bit address \regpair{ext2}{rs2}.  The most significant 64-bits of the source 
...
128-bit address \regpair{ext2}{rs1}.  Store the results in \textit{rd}.  
...
128-bit address \regpair{ext2}{rs1}.  Store the result sign extended to 64 bits in \textit{rd}.  
The effective address is calculated as follows:
...
Load an 16-bit word from the address formed by adding the immediate value to the 
128-bit address \regpair{ext2}{rs1}.  Store the result zero extended to 64 bits in \textit{rd}.  The effective 
address is calculated as follows:
...
Load an 64-bit word from the address formed by adding the immediate value to the 
128-bit address \regpair{ext2}{rs1}.  Store the results in \textit{extd}.  
The effective address is calculated as follows:
...
128-bit address \regpair{ext3}{rs2}.  The effective address is calculated 
as follows: 
