...
\hline
esd rs1, imm(rs2) & rs1 & rs2+ext2 & 011 & 1111111\\
\hline
esw rs1, imm(rs2) & rs1 & rs2+ext2 & 010 & 1111111\\
\hline
esh rs1, imm(rs2) & rs1 & rs2+ext2 & 001 & 1111111\\
\hline
esb rs1, imm(rs2) & rs1 & rs2+ext2 & 000 & 1111111\\
\hline
\end{tabular}
\end{center}
\end{table}
...
Mnemonic & base & funct3 & dest & opcode \\ \hline
\hline
elq rd, imm(rs1) & rs1+ext1 & 110 & rd & 1111111\\
\hline
ele extd, imm(rs1) & rs1+ext1 & 111 & rd & 1111111\\
\hline
\end{tabular}
\end{center}
\end{table}
...
Mnemonic & base & funct3 & dest & opcode \\ \hline
\hline
eaddi rd, ext1, imm & ext1 & 010 & rd & 1111111\\
\hline
eaddie extd, rs1, imm & rs1 &011 & extd & 1111111\\
\hline
eaddix extd, ext1, imm & extd & 110 & ext1 & 1111111\\
\hline
\end{tabular}
\end{center}
\end{table}
